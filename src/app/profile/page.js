...
// ))(({ theme }) => ({
//   // ... (your existing styles for IOSSwitch)
// }));
...
//             <Typography class="tag2">
//               Your new Sub User will get a password reset link on their official
//               email address.
//             </Typography>
//           </div>
//           <Button onClick={handleClose} className="handle-got-it">
//             Got It!
//           </Button>
//         </Box>
//       </Modal>
...
//               <h2 id="parent-modal-title" style={{ fontFamily: "Roboto" }}>
//                 Add Sub User{" "}
//                 <CloseIcon onClick={handleClose} sx={{ marginLeft: 26.5 }} />
//               </h2>
//             </div>
//           </div>
...
//     //         return (
//     //             <>
//     //                 <Link href="./memdir"><EditSharpIcon style={{ color: "black", marginRight: '10px' }} /></Link>
